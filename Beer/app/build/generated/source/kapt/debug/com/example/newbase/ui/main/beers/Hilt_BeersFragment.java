 ...
 */
public abstract class Hilt_BeersFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BeersFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BeersFragment_GeneratedInjector) this.generatedComponent()).injectBeersFragment(UnsafeCasts.<BeersFragment>unsafeCast(this));
    }
  }
