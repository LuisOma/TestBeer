 ...
 */
public abstract class Hilt_BeersDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BeersDetailFragment() {
    super();
  }

  Hilt_BeersDetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BeersDetailFragment_GeneratedInjector) this.generatedComponent()).injectBeersDetailFragment(UnsafeCasts.<BeersDetailFragment>unsafeCast(this));
    }
  }
